...
class BookingAPITest(TestCase):
    ...
    def test_create_room_and_booking(self):
        ...
        resp = self.client.post(
            "/api/rooms/create", data={"description": "Test room", "price": 100.00}
        )
        ...
        b = Booking.objects.create(
            room_id=room_id, date_start=date(2023, 1, 1), date_end=date(2023, 1, 3)
        )
    ...
    def test_create_booking_via_api(self):
        ...
        # Создаём комнату через API
        resp = self.client.post(
            "/api/rooms/create", data={"description": "Test room for booking", "price": 150.00}
        )
        self.assertEqual(resp.status_code, 200)
        room_data = resp.json()
        room_id = room_data["room_id"]
        ...
        b = Booking.objects.create(
            room_id=room_id, date_start=date(2023, 2, 1), date_end=date(2023, 2, 5)
        )
    ...
    def test_overlapping_booking_blocked(self):
        ...
        resp = self.client.post(
            "/api/bookings/create",
            data={"room_id": r.id, "date_start": "2023-01-12", "date_end": "2023-01-13"},
        )
    ...
    def test_invalid_dates(self):
        ...
        resp = self.client.post(
            "/api/bookings/create",
            data={"room_id": r.id, "date_start": "2023-01-10", "date_end": "2023-01-05"},
        )
